        ...
        <div id="wrapper" class="toggled">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="/create/live-page">
              @csrf <!-- {{ csrf_field() }} -->
              <span>Live Url:<input type="text" name="live_url" value="{{ $datas->live_url}}" /></span><br/>
              <input type="submit" value="Click to create Live URL" class="btn btn-success"/>
                    @endforeach
