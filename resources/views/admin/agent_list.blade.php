...
@media(min-width:768px) {
  ...
  <div class="card-body">
    ...
    <p class="card-text">Cellphone Number:{{ $datas->cellphone_number}}</p><br/>
    <p class="card-text">Address:{{ $datas->address}}</p><br/>
    <p class="card-text">Commission Rate:{{ $datas->commission_rate}}</p><br/>
    <a href="/agent/create/{{$datas->id}}" class="btn btn-primary">Click to Update</a>
  </div>
</div>
                    @endforeach
